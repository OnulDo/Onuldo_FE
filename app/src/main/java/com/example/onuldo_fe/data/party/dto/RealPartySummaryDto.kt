...
data class RealPartySummaryDto(
    ...
    val challengeId: Long = 0,            // 연결된 챌린지 ID
    ...
    val myStatus: String? = null,         // 구버전 응답의 나의 오늘 인증 상태
    @SerializedName(value = "myDailyStatus", alternate = ["MyDailyStatus"])
    val myDailyStatus: String? = null,    // 오늘 나의 데일리 인증 상태
...
data class PartyListMemberDto(
    ...
    val profileImageUrl: String? = null, // 회원 프로필 이미지 URL
