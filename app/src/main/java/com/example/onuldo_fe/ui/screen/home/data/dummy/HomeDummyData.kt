...
object HomeDummyData {
    val withChallenges = HomeResponseDto(
        ...
        partyChallenges = listOf(
            HomePartyChallengeDto("새벽 러너 파티", "30분 러닝", "D-12", "7:00 마감", "1시간 30분 남음", 2, 5),
            HomePartyChallengeDto("러너 파티", "2시간 러닝", "D-12", "9:00 마감", "", 4, 5)
        ),
        challenges = listOf(
            HomeChallengeDto("30분 러닝", "12일 연속 성공", "D-12", "7:00 마감", "인증하기", "NEED_CERTIFICATION"),
    ...
    val empty = HomeResponseDto(null, emptyList(), emptyList(), emptyList())
}
